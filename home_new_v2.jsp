                  ...
                  <div class="container" style="padding-left:0px;width:100%;">
                    ...
                    <div id="navbar" style="align-content:right;margin-right:3%;">
                      <ul class="nav navbar-nav navbar-right" style="float:right;">
                        ...
                        <% if(flag_Stats==1){
                          %>
                          <!-- Display Only if Stats Are Available -->
                  ...
                  <div class="tab-pane active" id="AggregateReports">
                    <div class="row" style="margin-right:0;">
                      <div class="col-md-2" style="position:fixed;background-color:#f8f8f8;z-index:1000;">
                        ...
                        <!-- Hide Scroll Bar if Page is Not Completed Filled -->
                        <div class="col-md-2" style="position:fixed;background-color:#f8f8f8;overflow-y:auto;overflow-x:hidden;max-height: 84%">
                          ...
                          if(!errorMsg.contains("Unable to fetch data"))
                          {
                            ...
                            <ul style="list-style:none;padding:0px">
                              <div class="col-md-4">
                                <%   int halfProductsCount = (listOfFoldersAggregate.length-1) / 2  ; %> <!-- Both Columns Contains Nearly Equal Number of Products --> <%
                                ...
                                <div class="row" style="margin-right:0;">
                                  ...
                                  <div class="col-md-2" style="position:fixed;background-color:#f8f8f8;z-index:1000;">
                                    ...
                                    <div class="col-md-2" style="position:fixed;background-color:#f8f8f8;overflow-y:auto;overflow-x:hidden;max-height: 84%">
                                      <ul style="list-style:none;padding:0px">
                                        <div class="col-md-4">
                                          <% halfProductsCount = (listOfFoldersResponseTime.length - 1) /2;
                                      ...
                                      <div class="col-md-10 col-md-offset-2">
                                        ...
                                        for(int i=0; i < listOfFoldersResponseTime.length;i++)
                                        {
                                          ...
                                          <div class="text-center">
                                            <!-- Simply pass the image path to src -->
                                          ...
                                          <ul style="list-style:none;padding:0px">
                                            <div class="col-md-4">
                                              ...
                                              for(int i=0; i<mainFolders.length;i++){
                                                ...
                                                %>
                                                <!-- Taking the fileName that starts with name --><%
                                              ...
                                              halfProductsCount = (mainFolders.length -1) / 2 ;
                                              for(int i=0; i <mainFolders.length;i++)
                                              {
